...
const SocialMediaSidebar = () => {
  return (
    <div className="fixed top-1/2 left-0 transform -translate-y-1/2 flex flex-col items-center space-y-6 p-2">
      ...
      <a href="https://www.linkedin.com/in/aarushi-khatri-1b162120b/" target="_blank" rel="noopener noreferrer" className="transform transition-transform duration-300 hover:scale-110">
      ...
      <a href="https://www.instagram.com/s.o.ideas/" target="_blank" rel="noopener noreferrer" className="transform transition-transform duration-300 hover:scale-110">
